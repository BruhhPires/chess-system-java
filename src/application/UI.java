...
public class UI {
	...
	// ABAIXO TEMOS OS CÓDIGOS PARA MUDAR A COR
	...
	public static ChessPosition readChessPosition(Scanner sc) { 		 	 // ESSE METODO RECEBERA O SCANNER DO PROGRAMA PRINCIPAL RECEBE AQUI COMO ARGUEMTNO
		try {
		String s = sc.nextLine();
		char column = s.charAt(0);
		int row = Integer.parseInt(s.substring(1));							 // RECORTA O STRING APARTIR DA POSIÇÃO 1 DO S.CHART E COLOCA NA POSIÇÃO ROW
	...
	public static void printMatch(ChessMatch chessMatch, List<ChessPiece> captured) {  				// IMPRIME O TABULEIRO // USA TBM A LISTA COMO PARAMETRO
		...
		if (!chessMatch.getCheckMate()) {															// SE NÃO TIVER COM CHECKMATE, ESPERA A PROXIMO JOGADA
		System.out.println("Waiting player: " + chessMatch.getCurrentPlayer());
		if(chessMatch.getCheck()) {
			System.out.println("CHECK! ");
		}
	}
		else { 																						// SE TIVER COM CHECKMATE, FINALIZA E DA MSG
